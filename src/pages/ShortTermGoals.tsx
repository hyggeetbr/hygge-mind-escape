    ...
    >
      ...
      <div className="relative z-20 flex items-center justify-between p-6">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="text-white text-3xl font-light mb-1">Short Term Goals</h1>
            <p className="text-white/60 text-sm">Plan and achieve your immediate objectives</p>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 px-6 pb-32">
        ...
        <div className="calm-card p-6 animate-fade-in">
          <h2 className="text-xl font-medium mb-6 text-black">Your Short Term Goals</h2>
                  ...
                  <button
                    ...
                    className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                      goal.is_completed
                        ...
                        : 'border-gray-300 hover:border-calm-blue'
                    }`}
                  >
